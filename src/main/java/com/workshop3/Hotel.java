...
class Hotel {
    ...
    /**
     * The getSpecialAvgRate method returns the value of the variable specialAvgRate.
    ...
    /**
     * The setAvgRate method takes a parameter (specialAvgRate) and assigns it to the specialAvgRate variable
    ...
    /**
     * The setAvgRate method takes a parameter (avgRate) and assigns it to the avgRate variable
